    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        /*if(shapes=='A'){
            if((int)orientations>=65&&(int)orientations<=68){
                FileInputStream inputstream = new FileInputStream("/Users/zhangxiaodi/IdeaProjects/comp1110-ass2/src/comp1110/ass2/gui/assets/AA.png");
                Image image=new Image(inputstream);
                ImageView imageView=new ImageView(image);
                imageView.setRotate((orientations-65)*90);
                imageView.setX(200);
                imageView.setY(200);
